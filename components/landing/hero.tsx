            ...
            <div className="container relative z-10 grid lg:grid-cols-2 gap-12 items-center px-4">
                ...
                >
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-4 sm:mb-6 tracking-tight leading-tight">
                        ...
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-emerald-400 to-teal-400 animate-gradient-x">
                            inspire.
                        </span>
                    </h1>
                ...
                >
                    <div className="relative w-full aspect-square">
                        ...
                        >
                            <div className="h-40 bg-emerald-900/20 rounded-xl mb-4 overflow-hidden relative">
